									...
									<table border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td>
												...
												<hr />
												<p>You have successfully book a cargo with us!</p>
												<h4>Your reference number is <strong>{{$payment->ticket->ticket_number}}</strong></h4>
												<h4>Current tracking status <strong>{{$payment->ticket->status}}</strong></h4>
												<h4>payment status <strong>{{$payment->payment_status === 1 ? 'Paid' : ($payment->ticket->status === 2 ? 'Not Paid' : 'Canceled')}}</strong></h4>
												<h4>base amount <strong>{{$payment->amount}}</strong></h4>
												<h4>additional fee <strong>{{$payment->additional_fee}}</strong></h4>
												<h4>amount to pay <strong>{{$payment->total_amount}}</strong></h4>
